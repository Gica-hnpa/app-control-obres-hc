...
function DocViewer({doc,obra,client,close,email}){
  ...
  function printIsolated(){
    const win=window.open('', '_blank', `width=${Math.max(1100, Math.floor((window.screen?.availWidth||1400)*0.96))},height=${Math.max(800, Math.floor((window.screen?.availHeight||900)*0.92))},left=10,top=10`);
