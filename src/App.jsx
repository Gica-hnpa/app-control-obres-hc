            ...
            {open[cap]&&<div className="budget-v25-lines">
              ...
              {items.map((r,i)=>{
                ...
                return <div className="budget-v25-line" key={i}>
                  ...
                  <div className="budget-concept-v875"><div className="budget-concept-v877"><div className="concept-line-v877"><input value={r.concepte||""} onChange={e=>upd(cap,i,"concepte",e.target.value)}/>{r.desc&&<button type="button" className="desc-toggle-v877" onClick={()=>setDescOpen875(o=>({...o,[`${cap}-${i}`]:!o[`${cap}-${i}`]}))}>{descOpen875[`${cap}-${i}`]?"Amagar":"Veure desc."}</button>}</div>{r.desc&&descOpen875[`${cap}-${i}`]&&<small>{r.desc}</small>}</div>{r.desc&&<button type="button" className="desc-toggle-v875" onClick={()=>setDescOpen875(o=>({...o,[`${cap}-${i}`]:!o[`${cap}-${i}`]}))}>{descOpen875[`${cap}-${i}`]?"Amagar descripció":"Veure descripció"}</button>}{r.desc&&descOpen875[`${cap}-${i}`]&&<small>{r.desc}</small>}</div>
