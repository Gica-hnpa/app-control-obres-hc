...
useEffect(()=>{
  ...
  // V87.84: càrrega blindada. Si alguna dada local s'ha corromput, no ha de bloquejar el login d'Héctor.
  let c=loadUserJson8784("aco_clients",(isHector?clients0:[]),authUser8779);
  let o=loadUserJson8784("aco_obres",(isHector?obres0:[]),authUser8779);
  let d=loadUserJson8784("aco_odata",(isHector?data0:{}),authUser8779);
...
const setD=(id,up)=>{
  ...
  setOdata(p=>{
    const current=p[id]||empty();
    const next=typeof up==="function"?up(current):up;
    return {...p,[id]:{...next,updatedAt:now}};
  });
